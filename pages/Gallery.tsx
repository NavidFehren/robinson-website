        ...
        <div className="grid grid-cols-[1fr_minmax(280px,320px)_1fr] gap-6 lg:gap-8 xl:gap-10 items-center min-h-[500px]">
          ...
          <div className="flex flex-col items-center justify-center text-center py-12">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 gradient-primary text-white px-8 py-3 rounded-full transition-colors font-medium"
            >
      ...
      <div className="lg:hidden px-4">
        ...
        <div className="text-center py-8">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 gradient-primary text-white px-6 py-3 rounded-full transition-colors font-medium"
          >
            <Instagram className="w-5 h-5" />
            {content.instagram.buttonText}
          </a>
